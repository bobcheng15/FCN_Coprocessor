...
FIRMWARE_OBJS = firmware/start.o firmware/irq.o firmware/print.o firmware/nn_pcpi.o firmware/knn_mmap.o firmware/stats.o
DBFILE      = *.fsdb *.vcd *.bak
...
pcpi: firmware/firmware.hex
	ncverilog testbench_pcpi.v nn_pcpi.sv picorv32.v +define+COMPRESSED_ISA +access+r

mmap: firmware/firmware.hex
	ncverilog testbench_mmap.v knn_mmap.v picorv32.v +define+COMPRESSED_ISA +access+r

pcpi_fsdb: firmware/firmware.hex
	ncverilog testbench_pcpi.v knn_pcpi.sv picorv32.v +define+COMPRESSED_ISA +fsdb +trace +noerror +access+r

mmap_fsdb: firmware/firmware.hex
	ncverilog testbench_mmap.v knn_mmap.v picorv32.v +define+COMPRESSED_ISA +fsdb +trace +noerror +access+r
